...
<img width="1219" height="999" alt="drupal" src="https://github.com/user-attachments/assets/17e953ce-9dfb-42f9-b058-ea42379c07af" />
...
````
          ...
          ------------------------
          |                      |
localhost:9700         localhost:9500
     |                        |
     v                        v
[ server-drupal ]     [ client-postgres ]
        |                        |
        |                        |
        |-------- (net-drupal) --|
                     |
